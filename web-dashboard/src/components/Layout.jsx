...
const NAV = [
  ...
  { to: '/peta', label: 'Peta Kampus', icon: '⚑', roles: ['viewer', 'operator', 'admin', 'superadmin'] },
...
const TITLES = {
  '/': 'Dashboard Home', '/roadmap': 'Roadmap CAPEX', '/bangunan': 'Data Bangunan', '/peta': 'Peta Kampus',
      ...
      <div className="app-shell">
        <aside className="sidebar">
          ...
          <div className="sidebar-footer">
            Multi-PT &middot; Periode 2026&ndash;2030
          </div>
        </aside>
        <div className="main">
